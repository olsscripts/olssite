...
function usage
{
    ...
    echo
    echoY "EXAMPLES                           "
    echoG "./olssite.sh                       " "To install the latest version of OpenLiteSpeed with a random WebAdmin password."
    echoG "./olssite.sh --lsphp 72            " "To install the latest version of OpenLiteSpeed with lsphp72."
    echoG "./olssite.sh -a 123456 -e a@cc.com " "To install the latest version of OpenLiteSpeed with WebAdmin password  \"123456\" and email a@cc.com."
    echoG "./olssite.sh -s yourdomain.com     " "To install OpenLiteSpeed with yourdomain.com"."
    echo
